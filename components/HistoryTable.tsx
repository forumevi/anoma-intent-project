...
import { Intent } from '../data/sampleHistory';
      ...
      <table className="min-w-full divide-y divide-gray-700">
        <thead className="bg-gray-800">
          <tr>
            ...
            <th className="px-4 py-2 text-left text-sm font-semibold text-white">Chain</th>
        ...
        <tbody className="divide-y divide-gray-700">
          {intents.map((intent, index) => (
            ...
            >
              ...
              <td className="px-4 py-2">{intent.chain}</td>
              ...
              <td className="px-4 py-2">{intent.date}</td>
            </motion.tr>
          ))}
        </tbody>
      </table>
